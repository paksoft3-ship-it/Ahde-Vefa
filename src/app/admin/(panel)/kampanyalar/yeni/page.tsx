...
export default function NewCampaignPage() {
  ...
  const [form, setForm] = useState({
    title: "",
    category: "Genel" as CampaignCategory,
    region: "Genel" as Region,
    status: "Taslak" as CampaignStatus,
    summary: "",
    description: "",
    suggestedAmounts: "",
  });
  ...
  return (
    <div>
      <AdminPageHeader
        title="Yeni Kampanya"
        description="Kampanya temel bilgilerini girin. Yasal alanlar Ayarlar'dan yönetilir."
        breadcrumb={[
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Field label="Kampanya Başlığı" htmlFor="title" required className="sm:col-span-2">
              <Input
                ...
                placeholder="Örn. Su Kuyusu Projeleri"
              />
            </Field>
